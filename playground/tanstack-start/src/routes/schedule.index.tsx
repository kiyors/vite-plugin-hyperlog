        ...
        <div className="relative py-16 px-6">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-cream/70 max-w-2xl mx-auto font-body">
              Three days of masterclasses, demonstrations, and culinary inspiration from the world's finest pastry
              artisans.
            </p>
          </div>
        </div>
          ...
          <div className="flex justify-center">
            <div className="inline-flex bg-card/50 rounded-2xl p-2 border border-border/50">
              {scheduleData.map((day) => (
                ...
                >
                  <span className="block text-xs uppercase tracking-wider opacity-75">{day.dayName}</span>
