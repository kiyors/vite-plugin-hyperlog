...
import LoggerTester from "#/components/LoggerTester";
...
function HomePage() {
  ...
  return (
    <>
      <RemyAssistant />
      <div className="pt-24 px-6 bg-charcoal">
        <LoggerTester />
      </div>
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center px-6 overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto text-center z-10">
          ...
          <p className="text-xl md:text-2xl text-cream/70 font-body max-w-3xl mx-auto mb-10 leading-relaxed">
            Join the world's most celebrated pastry chefs and master bakers for three extraordinary days of
            masterclasses, demonstrations, and culinary inspiration.
          </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex items-end justify-between mb-12">
            <div>
              ...
              <p className="text-cream/60 text-lg font-body">Learn from award-winning pastry chefs and master bakers</p>
            </div>
            <Link
              to="/speakers"
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex items-end justify-between mb-12">
            <div>
              ...
              <p className="text-cream/60 text-lg font-body">Masterclasses and demonstrations to elevate your craft</p>
            </div>
            <Link
              to="/talks"
              className="hidden md:inline-flex items-center gap-2 text-gold hover:text-gold/80 transition-colors font-medium"
