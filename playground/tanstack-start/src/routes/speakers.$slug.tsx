  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-6 py-4">
        <Link to="/speakers" className="inline-flex items-center gap-2 text-cream/60 hover:text-gold transition-colors">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2 flex flex-col justify-center">
              ...
              <h1 className="font-display text-5xl md:text-6xl font-bold text-cream mb-3">{speaker.name}</h1>
      ...
      {speakerTalks.length > 0 && (
        <div className="max-w-7xl mx-auto px-6 py-12">
          <h2 className="font-display text-3xl font-bold text-cream mb-8">Sessions by {speaker.name}</h2>
